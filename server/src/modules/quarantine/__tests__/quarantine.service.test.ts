...
describe('Quarantine Service', () => {
  ...
  it('creates active quarantine, moves pen occupancy, and transitions livestock status', async () => {
    mockLivestockFindById.mockResolvedValue({ current_pen_id: { toString: () => 'pen-old' } });
