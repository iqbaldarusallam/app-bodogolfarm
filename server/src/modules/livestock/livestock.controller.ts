...
export async function getById(req: AuthenticatedRequest, res: Response, next: NextFunction) {
  try {
    const livestock = await livestockService.getById(req.params.id);
...
export async function create(req: AuthenticatedRequest, res: Response, next: NextFunction) {
  try {
    const livestock = await livestockService.create(req.body, req.user!.userId);
...
export async function update(req: AuthenticatedRequest, res: Response, next: NextFunction) {
  try {
    const livestock = await livestockService.update(req.params.id, req.body);
    res.status(200).json({ success: true, data: livestock });
  } catch (error) {
    next(error);
  }
...
export async function remove(req: AuthenticatedRequest, res: Response, next: NextFunction) {
  try {
    const result = await livestockService.remove(req.params.id);
...
export async function getTimeline(req: AuthenticatedRequest, res: Response, next: NextFunction) {
  try {
    const timeline = await livestockService.getTimeline(req.params.id);
